        ...
        <div className='main'>
            <div className='mainDiv'>
                ...
                <ul>
                    ...
                    <li>The styling in intentionally bland in some spots. Just a sandbox.</li>
                    ...
                    <li>his app simply scratches the surface on what si possible with React.</li>
                    <li>We have tried to collect the very best resources for this app, and we have ited those <Link to='/resources'>here</Link>.</li>
